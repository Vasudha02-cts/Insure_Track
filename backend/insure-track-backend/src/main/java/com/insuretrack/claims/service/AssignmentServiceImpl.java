...
//
//        if (claim.getStatus() != ClaimStatus.INVESTIGATING)
//            throw new RuntimeException("Assignment allowed only in review stage");
//
//        assignmentRepository.findByClaimClaimId(claimId)
//                .ifPresent(a -> { throw new RuntimeException("Claim already Assigned"); });
//
//        // FIX: Do not set assignmentId.
//        // If you have a UserRepository, you should fetch the User(Adjuster) here.
//        ClaimAssignment assignment = ClaimAssignment.builder()
//                .claim(claim)
//                // .assignmentId(dto.getAdjusterId()) <--- REMOVE THIS LINE
//                .priority(dto.getPriority())
//                .assignmentDate(LocalDate.now())
//                // .adjuster(adjusterUser) <--- Set the actual User object if available
//                .build();
//
//        ClaimAssignment savedAssignment = assignmentRepository.save(assignment);
//
//        return AssignmentResponseDTO.builder()
//                .assignmentId(savedAssignment.getAssignmentId()) // Return the DB-generated ID
//                .claimId(claimId)
//                .adjusterId(dto.getAdjusterId())
//                .priority(dto.getPriority())
//                .assignmentDate(savedAssignment.getAssignmentDate())
//                .build();
//    }
//
//    @Override
...
//                .assignmentId(assignment.getAssignmentId())
//                .claimId(assignment.getClaim().getClaimId())
//                .adjusterId(assignment.getAssignmentId())
//                .priority(assignment.getPriority())
//                .assignmentDate(assignment.getAssignmentDate())
//                .build();
//    }
